Map<String, String> englishLanguage = {
  ...
  "login_now_to_explore_courses": "Login now to chat with others",
  "email": "Email",
  "password": "Password",
  ...
  "success": "Success",
  "register_now_to_explore_our_courses": "Sign up now to chat with others",
  "name": "Name",
  "phone": "Phone",
  "sign_up": "Sign up",
  "we_will_send_you_a_code":
      "We will send you a code so that you can reset your password",
  "check_your_email": "Check your email",
  "confirm": "Confirm",
  "please_enter_code_you_recieved_in_your_email":
      "Please enter code you recieved in your email",
  "code": "Code",
  ...
  "password_note":
      "If you want to add new password write new password if you don't write your current password",
  ...
  "has_been_added":
      "has been added to the course that you purchased, which was titled",
  ...
  "more": "More",
  "friends": "Friends",
  "confirm_dialog_default_title": "Confirmation",
